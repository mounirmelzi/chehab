#!/bin/bash
# ═══════════════════════════════════════════════════════════════
#  Demo 2: Encrypted Neural Network -- Layer-by-Layer Inference
#
#  Automated demo for PFE defense.
#  Run on HPC: sbatch or srun --pty bash run_demo2.sh
#  Run locally: bash run_demo2.sh
# ═══════════════════════════════════════════════════════════════
...
# ── Run demo ───────────────────────────────────────────────────
python3 "$SCRIPT_DIR/demo_neural_network.py"
