...
func getRotationSteps() []int {
	return []int{1, 12, 2, 8, 9, 10, 17, 6, 18, 7, 13, 14, 4, 16, 5}
}

func deep_conv2d_3layers(
	...
	c5, _ = eval.MulNew(c5, p3)
	c1, _ = eval.AddNew(c1, c5)
	c5, _ = eval.RotateNew(c4, 6)
	c5, _ = eval.MulNew(c5, p3)
	c1, _ = eval.AddNew(c1, c5)
	c5, _ = eval.RotateNew(c4, 7)
	c5, _ = eval.MulNew(c5, p3)
	c1, _ = eval.AddNew(c1, c5)
	c5, _ = eval.RotateNew(c4, 8)
	c5, _ = eval.MulNew(c5, p3)
	c1, _ = eval.AddNew(c1, c5)
	c5, _ = eval.RotateNew(c4, 12)
	c5, _ = eval.MulNew(c5, p3)
	c1, _ = eval.AddNew(c1, c5)
	c5, _ = eval.RotateNew(c4, 13)
	c5, _ = eval.MulNew(c5, p3)
	c1, _ = eval.AddNew(c1, c5)
	c4, _ = eval.RotateNew(c4, 14)
	...
	c5, _ = eval.MulNew(c5, p3)
	c4, _ = eval.AddNew(c4, c5)
	c5, _ = eval.RotateNew(c1, 4)
	c5, _ = eval.MulNew(c5, p3)
	c4, _ = eval.AddNew(c4, c5)
	c5, _ = eval.RotateNew(c1, 5)
	c5, _ = eval.MulNew(c5, p3)
	c4, _ = eval.AddNew(c4, c5)
	c5, _ = eval.RotateNew(c1, 6)
	c5, _ = eval.MulNew(c5, p3)
	c4, _ = eval.AddNew(c4, c5)
	c5, _ = eval.RotateNew(c1, 8)
	c5, _ = eval.MulNew(c5, p3)
...
func main() {
	...
	// Run computation
	deep_conv2d_3layers(encryptedInputs, encodedInputs, encryptedOutputs, encodedOutputs, encoder, enc, eval, params)
